package cn.connext.bbs.service;
...
public interface ArticleService {
     ...
     * @param content
     */
    void addArticle(int userid, String title,String author,Date date,String content,String type);
    ...
    void zhiding(int articleId);
    void jiajing(int articleId);
}
