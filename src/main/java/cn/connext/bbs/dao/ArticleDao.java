...
public interface ArticleDao {
     ...
     * @param content
     */
    void addArticle(@Param("userid") int userid,@Param("title") String title,@Param("author") String author,@Param("date") Date date,@Param("content") String content,@Param("type") String type);
    ...
    void zhiding(@Param("id")int id);
    void jiajing(@Param("id")int id);
}
