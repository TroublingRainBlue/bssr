...
public class UserController {
    ...
    @ResponseBody
    public String register(@RequestParam(value = "nickname")String nickname,@RequestParam(value="tel") String tel, @RequestParam(value="password")String password, HttpServletRequest request){
