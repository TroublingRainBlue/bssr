...
public class ArticleController {
    ...
    public String addArticle(@RequestParam("addArticleTitle")String addArticleTitle,
        ...
        articleService.addArticle(id,addArticleTitle,author,date,addArticleContent,type);
    ...
    public String zhiding(
        ...
        if(! (license.hasArticlePermission("置顶",user)))
        {
            String jsonStr = "{\"errorCode\":\"2\",\"errorMessage\":\"没有该权限！\"}";
            return jsonStr;
        }
        ...
        Date date=new Date();
        articleService.zhiding(articleId);
    ...
    public String jiajing(
        ...
        if(! (license.hasArticlePermission("加精",user)))
        {
            String jsonStr = "{\"errorCode\":\"2\",\"errorMessage\":\"没有该权限！\"}";
            return jsonStr;
        }
        ...
        Date date=new Date();
        articleService.jiajing(articleId);
